...
| 2 | [03-jpa-entity-from-sql-guide.md](03-jpa-entity-from-sql-guide.md) | JPA 입문자 | `V1__init.sql`을 보고 엔티티를 작성하는 방법 |
| 3 | [01-developer-a-workflow.md](01-developer-a-workflow.md) | 개발자 A | `booking`, `payment` — 주차별 진행 순서 |
| 3 | [02-developer-b-workflow.md](02-developer-b-workflow.md) | 개발자 B | `user`, `performance`, `waitingroom`, `notification` — 주차별 진행 순서 |
